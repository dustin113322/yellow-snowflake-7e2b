...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/yellow-snowflake-7e2b
```

A live public deployment of this template is available at [https://yellow-snowflake-7e2b.templates.workers.dev](https://yellow-snowflake-7e2b.templates.workers.dev)
